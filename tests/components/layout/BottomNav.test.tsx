...
// Mock the shared WywtPostDialog as a no-op so NavWearButton's lazy import
// doesn't try to reach into the real orchestrator (which would run the
// getWornTodayIdsForUserAction preflight + render the real WatchPickerDialog
// in jsdom). Phase 15 Plan 03b D-04: NavWearButton lazy target is now
// WywtPostDialog, not WatchPickerDialog.
...
describe('BottomNav (Phase 14 NAV-01, NAV-02, NAV-03, NAV-04, NAV-05, NAV-09, NAV-10)', () => {
  ...
  it('Test 15 — Wear is rendered via NavWearButton with appearance="bottom-nav" and click opens the dialog', () => {
    ...
    const watches: Watch[] = []
    render(<BottomNav username="alice" ownedWatches={watches} viewerId="u1" />)
