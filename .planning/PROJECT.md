...
**Active:** v4.0 Discovery & Polish — Phase 17 Catalog Foundation complete (2026-04-27). Canonical `watches_catalog` + daily snapshots tables, public-read RLS, fire-and-forget upserts on both write paths, idempotent backfill, and SECDEF refresh function with pg_cron schedule. 12/12 CAT-NN requirements satisfied; 56/56 phase 17 integration tests green. Unblocks /search Watches, /explore Trending, /evaluate deep-link.
