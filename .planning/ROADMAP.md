...
- [ ] 64-01-PLAN.md — Foundations: extract SpecsSublabel + CommentThread id=comments anchor + two Wave-0 static guards + repair the pre-existing PPR guard pattern (Wave 1)
...
| 64. Detail Page IA Redesign | 0/4 | Not started | - |