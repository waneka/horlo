...
**Plans**: 1 plan
- [x] 73-01-PLAN.md — Collapse handleSearchPick owned branches to single catalogId redirect; update T-70-01/T-70-02/WR-02 Test D push targets; delete WR-02 Test A (dead-path); pivot WR-01 Test B to structured-submit
