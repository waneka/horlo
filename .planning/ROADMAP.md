...
Plans:
- [ ] 999.1-01-PLAN.md — PreferencesClient error UX (MR-01) + remove dead UnauthorizedError imports (MR-02) + document MR-03 closure [Wave 1]
...
| 999.1. Phase 5 Code Review Follow-ups | 0/1 | Not started | - |
