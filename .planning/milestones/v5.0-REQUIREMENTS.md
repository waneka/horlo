# Requirements Archive: v5.0 Discovery North Star
...
**Status:** ✅ Complete — shipped v5.0 on 2026-05-16
**Started:** 2026-05-06
...
| REQ-ID | Phase | Status |
|--------|-------|--------|
| DEBT-09 | Phase 32 | ✅ Complete v5.0 |
| DISC-10 | Phase 33 | ✅ Complete v5.0 |
| DISC-12 | Phase 33b | ✅ Complete v5.0 |
| CAT-15 | Phase 34 | ✅ Complete v5.0 |
| CAT-16 | Phase 35 | ✅ Complete v5.0 |
| CAT-17 | Phase 36 | ✅ Shipped 2026-05-11 |
| CAT-14 | Phase 36 | ✅ Shipped 2026-05-11 |
| CAT-18 | Phase 37 | ✅ Complete v5.0 |
| CAT-13 | Phase 38 | ✅ Complete v5.0 |
| ~~DISC-09~~ | ~~Phase 39~~ → v5.1 | Promoted to v5.1 milestone 2026-05-12 (SEED-008) |
| DISC-11 (cheap tier) | Phase 39 | ✅ Complete v5.0 |
| DISC-11 (heavier tier + NSV-02/16) | Phase 39b | ✅ Complete v5.0 |
| SRCH-16 | Phase 40 | ✅ Complete v5.0 |
| FIT-05 | Phase 40 | ✅ Complete v5.0 |
| SET-13 | Phase 41 | ✅ Complete v5.0 |
| SET-14 | Phase 41 | ✅ Complete v5.0 |
| DEBT-10 | Phase 42 | ✅ Complete v5.0 |
| DEBT-11 | Phase 42 | ✅ Complete v5.0 |
| DEBT-12 | unscheduled (opportunistic — next prod deploy needing drizzle-kit migrate) | ⏳ Deferred — carried to v5.x |

**Coverage: 16/16 in-scope v5.0 requirements SHIPPED (17 → 16 after DISC-09 promotion to v5.1 milestone 2026-05-12). DISC-11 split across Phase 39 + 39b per the Phase 39 discuss-phase reframe. The 1 ad-hoc DEBT-12 was always "unscheduled / opportunistic" — never mapped to a v5.0 phase; carried forward as a known deferred housekeeping item. Phase 39c (Profile Layout Next 16 Conformance) was an inserted cache-conformance bugfix phase with no associated requirement.**
