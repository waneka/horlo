...
> **ARCHIVED 2026-05-28** — v7.0 SHIPPED. All 34/34 requirements complete. Original requirements document preserved verbatim below. See `.planning/milestones/v7.0-ROADMAP.md` for the milestone summary and `.planning/MILESTONES.md` for the cross-milestone history.
