...
ALTER TABLE "activities" ADD CONSTRAINT "activities_watch_id_watches_id_fk" FOREIGN KEY ("watch_id") REFERENCES "public"."watches"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "wear_events" ADD CONSTRAINT "wear_events_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "wear_events" ADD CONSTRAINT "wear_events_watch_id_watches_id_fk" FOREIGN KEY ("watch_id") REFERENCES "public"."watches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "activities_user_id_idx" ON "activities" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "activities_user_created_at_idx" ON "activities" USING btree ("user_id","created_at");--> statement-breakpoint
...
CREATE INDEX "wear_events_watch_worn_at_idx" ON "wear_events" USING btree ("watch_id","worn_date");--> statement-breakpoint
ALTER TABLE "watches" DROP COLUMN "last_worn_date";